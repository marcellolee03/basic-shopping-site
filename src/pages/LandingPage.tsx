...
export function LandingPage() {
    return (
        <>
            ...
            <div className='flex mx-30 items-center justify-center gap-20'>
                <div className='max-w-4xl'>
                    <p className='text-7xl font-extrabold font-inter text-white'>IT'S TIME TO BUILD YOUR DREAM CUSTOM KEYBOARD.</p>
                    <p className='text-2xl my-12 font-inter text-white'>Use our interactive builder to design your perfect keyboard step-by-step, or shop our collection of premium components.</p>
